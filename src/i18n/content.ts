  ...
  en: {
    ...
    sections: {
      ...
      about: {
        ...
        subtitle:
          "A clean section that builds trust even before you add real photos and certificates.",
      },
      process: {
        eyebrow: "How we work",
      ...
      contact: {
        ...
        subtitle:
          "Frontend-only demo form. Connect to backend or email later.",
      },
    },
    ...
    about: {
      ...
      p2:
        "Add your father’s real company story here: timeline, key projects, and specialties.",
      bullets: [
  ...
  ka: {
    ...
    sections: {
      services: {
        ...
        subtitle:
          "მოქნილი სერვისები საცხოვრებელი, კომერციული და სამრეწველო პროექტებისთვის.",
      },
      projects: {
        eyebrow: "პორტფოლიო",
        title: "შერჩეული სამუშაოები და კონცეპტები",
        subtitle:
          "ფილტრებით ორგანიზებული გალერეა ბრენდის სანდოობისთვის.",
      },
      testimonials: {
        eyebrow: "კლიენტები",
      ...
      about: {
        ...
        subtitle:
          "სუფთა და პროფესიონალური ბლოკი რეალური ისტორიის დასამატებლად.",
      },
      process: {
        eyebrow: "როგორ ვმუშაობთ",
        title: "მარტივი და სანდო პროცესები",
        subtitle:
          "გასაგები ნაბიჯები დროის, ბიუჯეტის და ხარისხის კონტროლისთვის.",
      },
      contact: {
        eyebrow: "კონტაქტი",
        title: "დავიწყოთ თქვენი პროექტი",
        subtitle:
          "მხოლოდ ფრონტენდი — შემდეგ მარტივად დაუკავშირებ ბექენდს.",
      },
    },
    ...
    services: [
      ...
      },
      {
        ...
        text:
          "მაღაზიები, ოფისები, ჰოსპიტალิตี้ — პროექტირება და მშენებლობა ერთიანად.",
    ...
    projects: [
      {
        ...
        category: "residential" as CategoryKey,
        note: "თანამედროვე ვილის კონცეპტი გამძლე მასალებით.",
      },
      {
        name: "ქალაქის რითეილი",
        category: "commercial" as CategoryKey,
        note: "ბრენდისთვის მორგებული შიდა განლაგება და ნაკადები.",
      },
      {
    ...
    process: [
      ...
      { title: "ჩაბარება", text: "საბოლოო შემოწმება და დოკუმენტაცია." },
    ],
  ...
  ru: {
    ...
    sections: {
      ...
      about: {
        ...
        subtitle:
          "Чистый раздел для добавления реальной истории компании.",
      },
      process: {
      ...
      contact: {
        ...
        subtitle:
          "Только фронтенд — позже легко подключите бэкенд.",
      },
    },
    ...
    projects: [
      {
        ...
        category: "residential" as CategoryKey,
        note: "Концепт современной виллы с прочными материалами.",
      },
      {
    ...
    process: [
      ...
      { title: "Сдача", text: "Финальные проверки и документация." },
    ],
